...
from projects.ST.dataset.COCO_Panoseg_Dataset import COCOSegmDataset
from projects.ST.dataset.COCO_Panoseg_Dataset_Semantic import COCOSemanticSegmDataset
from projects.ST.dataset.GLaMM_Dataset import GlammGrandfDataset, GlammRefcocogDataset, GlammOpenpsgDataset, GlammFlickerDataset
from projects.ST.dataset.PixeCap_Dataset import PixelCapSegDataset
from projects.ST.dataset.MUSE_Dataset import MuseDataset
from projects.ST.dataset.GRefCOCO_Dataset import GRefCoCoDataset
from projects.ST.dataset.PixeCapVisualPrompt_Dataset import PixelCapVisualPromptDataset
from projects.ST.dataset.OspreyVisualPrompt_Dataset import OspreyDescriptionDataset, OspreyShortDescriptionDataset, OspreyDataset
from projects.ST.dataset.collect_fns import st_collate_fn
from projects.ST.dataset.SamVisualPrompt_Dataset import SamVisualPromptDataset
from projects.ST.hooks.evaluation_chat_hook import EvaluateChatHook_ST
from projects.ST.dataset.COCOVisualPrompt_Dataset import COCOVisualPromptDataset
...
#######################################################################
# Model
tokenizer_path = './pretrained/single_transformer/3b/Qwen2.5MM-3B-ext-psz16/'
path = './pretrained/single_transformer/3b/qwen3B_capcls1.0_cotrain512M_imgfull_lr4e-4_sft/'
mask2former_path = "pretrained/mask2former/mask2former_swinl_coco_pano"
sam2_ckpt = "pretrained/sam2/sam21L/sam2.1_hiera_large.pt"
pretrained_pth = None
...
# coco vp cls
coco_vp_category_dataset = dict(
    type=COCOVisualPromptDataset,
    image_folder="data/coco/Images/train2017",
    pano_rgb_folder="data/coco/Annotations/annotations/panoptic_train2017/",
    pano_json="data/coco/Annotations/annotations/panoptic_train2017.json",
    class_txt="projects/ST/dataset/coco_panoptic_with_prompt_eng.txt",
...
train_dataset = dict(
    type=ConcatDataset, datasets=[
        ...
        refcoco_segm_dataset, refcoco_plus_segm_dataset, refcocog_segm_dataset,
        # gres
        gref_coco_segm_dataset, gref_coco_segm_dataset, gref_coco_segm_dataset,
        # image qa
        llava_vqa_dataset, llava_vqa_dataset,
        # pixel2cap vp
        pixelcap_vp_dataset,
        # osprey
