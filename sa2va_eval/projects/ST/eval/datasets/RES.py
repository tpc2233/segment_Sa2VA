...
from projects.ST.eval.utils import REFER, Summary, AverageMeter, intersectionAndUnionGPU, master_only, G_REFER
...
class RESDataset:
    ...
    def json_file_preprocess(self, data_path):
        ...
        if dataset_name == "grefcoco":
            ...
            # print(data_path, dataset_name, splitBy)
    ...
    def filter_data_dict(self, data_dict):
        ...
        # ret.update({"prefix_answer": "It is [SEG].",})
        return ret
